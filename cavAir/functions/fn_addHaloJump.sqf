 ...
 *
 * Example:
 * ["my_c130"] call cavAir_fnc_addHaloJump
 * ["my_c130", 5000] call cavAir_fnc_addHaloJump
 * ["my_c130", 5000, "B_Parachute"] call cavAir_fnc_addHaloJump
 *
 */
...
if (!isNil {_vehicle getVariable QEGVAR(Vehicle,Halo)}) exitWith {};
