 ...
 *
 * Example:
 * ["my_c130"] call cavAir_fnc_addLineJump
 * ["my_c130", 180] call cavAir_fnc_addLineJump
 * ["my_c130", 180, 350, 300] call cavAir_fnc_addLineJump
 * ["my_c130", 180, 350, 300, "rhs_d6_Parachute"] call cavAir_fnc_addLineJump
 *
 */
...
if (!isNil {_vehicle getVariable QEGVAR(Vehicle,Jump)}) exitWith {};
